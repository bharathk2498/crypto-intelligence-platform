      ...
      <footer className="border-t border-border-subtle py-12 mt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-text-secondary">
                ...
                <li><a href="/risk" className="hover:text-text-primary">Risk Metrics</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-text-secondary">
                ...
                <li><a href="/docs" className="hover:text-primary">API Docs</a></li>
          ...
          <div className="mt-12 pt-8 border-t border-border-subtle text-center text-text-tertiary">
            <p>© 2025 Crypto Intelligence Platform. Not financial advice. Data provided as-is.</p>
          </div>
        </div>
      </footer>
    </div>
